...
class Network(nn.Module):
    def __init__(self):
        super().__init__()
        self.hl_1=nn.Linear(784,128)
        self.hl_2=nn.Linear(128,64)
        self.hl_3=nn.Linear(64,10)
    
    def forward(self,x):
        x=x.view(x.shape[0],-1)   # x.size(0) also works...here we flatten the image to a 1D vector of size 784 (28*28)
